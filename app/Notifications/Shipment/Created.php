...
class Created extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->line(__('notifications.shipment.created.body'))
            ->line(
                __(
            ...
            ->line(
                __(
                    'notifications.shipment.created.user',
                    [
                        'user' => $this->packingList->createdBy->name,
                    ]
                )
            )
            ->action(
                __('notifications.shipment.created.action'),
                $url
            )
            ->salutation(
