...
class CreateDocumentsShipmentProtocolsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('documents_shipment_protocols', static function (Blueprint $table) {
            $table->id();
        ...
        DB::statement(
            "ALTER TABLE `documents_shipment_protocols` COMMENT 'Протоколы'"
        );
    }
    ...
    {
        Schema::dropIfExists('documents_shipment_protocols');
    }
}
