...
return [
    ...
    'contractors' => [
        ...
        'places_of_business' => [
            'created' => [
                'subject' => 'Добавление нового места осуществления деятельности контрагента',
                'body' => 'Вы получили это письмо, так как было добавлено новое место осуществления деятельности.',
                'address' => 'Новый адрес: :address',
                'user' => 'Пользователь: :user',
                'action' => 'Проверить',
            ],
            'updated' => [
                'subject' => 'Изменение места осуществления деятельности контрагента.',
                'body' => 'Вы получили это письмо, так как было изменено место осуществления деятельности контрагента.',
            ],
        ],
    ],
    'shipment' => [
