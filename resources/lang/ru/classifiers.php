    ...
    'nomenclature' => [
        ...
        'products' => [
            ...
            'okpd2' => [
                ...
                'actions' => [
                    'update' => [
                        ...
                        'fail' => 'Не удалось обновить классификатор ОКПД2',
                    ],
                    'create' => [
                        'success' => 'Наименование :name успешно добавлено в классификатор ОКПД2',
                        'fail' => 'Не удалось добавить запись в классификатор ОКПД2',
                    ],
                ],
            ],
            'registration_numbers' => [
                ...
                'actions' => [
                    'update' => [
                        'success' => 'Классификатор регистрационных номеров готовой продукции успешно обновлен',
                        'fail' => 'Не удалось обновить классификатор регистрационных номеров готовой продукции'
                    ],
                    'create' => [
                        'success' => 'Регистрационный номер :number успешно добавлен в классификатор',
                        'fail' => 'Не удалось добавить :number в классификатор',
                    ],
                ],
            ],
