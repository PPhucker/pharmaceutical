...
return [
    ...
    'actions' => [
        'create' => [
            ...
            'fail' => 'Не удалось добавить контрагента'
        ],
        'update' => [
            'success' => 'Контрагент :name успешно обновлен',
            'fail' => 'Не удалось обновить контрагента'
        ],
        'delete' => [
    ...
    'places_of_business' => [
        ...
        'actions' => [
            'create' => [
                ...
                'fail' => 'Не удалось добавить место осуществления деятельности'
            ],
            'update' => [
    ...
    'bank_account_details' => [
        ...
        'actions' => [
            'create' => [
                ...
                'fail' => 'Не удалось добавить банковские реквизиты',
                'info' => 'Для добавления банковских реквизитов нажмите "Добавить"',
            ],
            'update' => [
