...
return [
    ...
    'backup_successful_subject' => 'Новая резервная копия :application_name успешно создана',
    'backup_successful_subject_title' => 'Резервная копия успешно создана',
    'backup_successful_body' => 'Резервная копия :application_name успешно создана и сохранена на диск :disk_name.',
