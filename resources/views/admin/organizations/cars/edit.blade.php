<x-form.nav-tab
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <x-form
                :route="route('organization.cars.update', ['car' => $organization->cars->first()->id ?: null])"
                formId="cars_main_form"
                method="PATCH">
                <x-data-table.table
                    id="cars_main_table"
                    ...
                    <x-data-table.body>
                        @foreach($organization->cars as $key => $car)
                            <x-data-table.tr
                                :model="$car">
