...
@if($trashed)
    ...
    <div>
        <a class="btn btn-hover"
           ...
           onclick="event.preventDefault();document.getElementById('{{$route}}-restore-form-{{$id}}').submit();"
...
@else
    ...
    <div>
        <a class="btn btn-hover"
           ...
           id="{{$route}}-button-{{$id}}"
           onclick="event.preventDefault();document.getElementById('{{$route}}-destroy-form-{{$id}}').submit();"
